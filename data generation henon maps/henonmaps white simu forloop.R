...
for (timelength in timelength_sets) {
  for (bd in bd_sets) {
    for (noiselevel in noiselevel_sets) {
      ...
      crosscorrelationsave <- phasesynsave <- misave <- kullbacksave <- jsave <- dasave <- jrsave <- coherencesave <- list()
      estimates <- list()
      ...
      for (times in 1:20) {
        ...
        MSEk_lowc <- mean((crosscorrelation[1:20] - (1-kullback[1:20]))^2) 
        crk_lowc <- cor((1-kullback[1:20]),crosscorrelation[1:20])#-0.4
        MSEj_lowc <- mean((crosscorrelation[1:20] - (1-j[1:20]))^2)
        crj_lowc <- cor(1-j[1:20],crosscorrelation[1:20])#-0.4
        MSEmi_lowc <- mean((crosscorrelation[1:20] - mi[1:20])^2)
        crmi_lowc <- cor(mi[1:20],crosscorrelation[1:20])#0.000217
        MSEphasesyn_lowc <- mean((crosscorrelation[1:20] - phasesyn[1:20])^2)
        crphasesyn_lowc <- cor(phasesyn[1:20],crosscorrelation[1:20])
        ...
        MSEda01_lowc <- mean((crosscorrelation[1:20] - (1-da01[1:20]))^2)
        crda01_lowc <- cor((1-da01[1:20]),crosscorrelation[1:20])
        
        MSEda05_lowc <- mean((crosscorrelation[1:20] - (1-da05[1:20]))^2)
        crda05_lowc <- cor(1-da05[1:20],crosscorrelation[1:20])
        
        MSEda09_lowc <- mean((crosscorrelation[1:20] - (1-da09[1:20]))^2)
        crda09_lowc <- cor(1-da09[1:20],crosscorrelation[1:20])
        
        MSEjr2_lowc <- mean((crosscorrelation[1:20] - (1-jr2[1:20]))^2)
        crjr2_lowc <- cor((1-jr2[1:20]),crosscorrelation[1:20])
        
        MSEjr6_lowc <- mean((crosscorrelation[1:20] - (1-jr6[1:20]))^2)
        crjr6_lowc <- cor(1-jr6[1:20],crosscorrelation[1:20])
        
        MSEjr10_lowc <- mean((crosscorrelation[1:20] - (1-jr10[1:20]))^2)
        crjr10_lowc <- cor((1-jr10[1:20]),crosscorrelation[1:20])
        ...
        #
        MSEk_avgc <- mean((crosscorrelation[21:40] - (1-kullback[21:40]))^2) 
        crk_avgc <- cor((1-kullback[21:40]),crosscorrelation[21:40])#-0.4
        MSEj_avgc <- mean((crosscorrelation[21:40] - (1-j[21:40]))^2)
        crj_avgc <- cor(1-j[21:40],crosscorrelation[21:40])#-0.4
        MSEmi_avgc <- mean((crosscorrelation[21:40] - mi[21:40])^2)
        crmi_avgc <- cor(mi[21:40],crosscorrelation[21:40])#0.000217
        
        MSEphasesyn_avgc <- mean((crosscorrelation[21:40] - phasesyn[21:40])^2)
        crphasesyn_avgc <- cor(phasesyn[21:40],crosscorrelation[21:40])
        
        
        
        MSEda01_avgc <- mean((crosscorrelation[21:40] - (1-da01[21:40]))^2)
        crda01_avgc <- cor((1-da01[21:40]),crosscorrelation[21:40])
        
        MSEda05_avgc <- mean((crosscorrelation[21:40] - (1-da05[21:40]))^2)
        crda05_avgc <- cor(1-da05[21:40],crosscorrelation[21:40])
        
        MSEda09_avgc <- mean((crosscorrelation[21:40] - (1-da09[21:40]))^2)
        crda09_avgc <- cor(1-da09[21:40],crosscorrelation[21:40])
        
        MSEjr2_avgc <- mean((crosscorrelation[21:40] - (1-jr2[21:40]))^2)
        crjr2_avgc <- cor((1-jr2[21:40]),crosscorrelation[21:40])
        MSEjr6_avgc <- mean((crosscorrelation[21:40] - (1-jr6[21:40]))^2)
        crjr6_avgc <- cor(1-jr6[21:40],crosscorrelation[21:40])
        
        MSEjr10_avgc <- mean((crosscorrelation[21:40] - (1-jr10[21:40]))^2)
        crjr10_avgc <- cor((1-jr10[21:40]),crosscorrelation[21:40])
        ...
        #
        MSEk_highc <- mean((crosscorrelation[41:60] - (1-kullback[41:60]))^2) 
        crk_highc <- cor((1-kullback[41:60]),crosscorrelation[41:60])#-0.4
        MSEj_highc <- mean((crosscorrelation[41:60] - (1-j[41:60]))^2)
        crj_highc <- cor(1-j[41:60],crosscorrelation[41:60])#-0.4
        MSEmi_highc <- mean((crosscorrelation[41:60] - mi[41:60])^2)
        crmi_highc <- cor(mi[41:60],crosscorrelation[41:60])#0.000217
        
        MSEphasesyn_highc <- mean((crosscorrelation[41:60] - phasesyn[41:60])^2)
        crphasesyn_highc <- cor(phasesyn[41:60],crosscorrelation[41:60])
        
        
        
        MSEda01_highc <- mean((crosscorrelation[41:60] - (1-da01[41:60]))^2)
        crda01_highc <- cor((1-da01[41:60]),crosscorrelation[41:60])
        MSEda05_highc <- mean((crosscorrelation[41:60] - (1-da05[41:60]))^2)
        crda05_highc <- cor(1-da05[41:60],crosscorrelation[41:60])
        MSEda09_highc <- mean((crosscorrelation[41:60] - (1-da09[41:60]))^2)
        crda09_highc <- cor(1-da09[41:60],crosscorrelation[41:60])
        
        MSEjr2_highc <- mean((crosscorrelation[41:60] - (1-jr2[41:60]))^2)
        crjr2_highc <- cor((1-jr2[41:60]),crosscorrelation[41:60])
        
        MSEjr6_highc <- mean((crosscorrelation[41:60] - (1-jr6[41:60]))^2)
        crjr6_highc <- cor(1-jr6[41:60],crosscorrelation[41:60])
        
        MSEjr10_highc <- mean((crosscorrelation[41:60] - (1-jr10[41:60]))^2)
        crjr10_highc <- cor((1-jr10[41:60]),crosscorrelation[41:60])
        ...
        MSEkc <- mean((crosscorrelation - (1-kullback))^2) 
        crkc <- cor((1-kullback),crosscorrelation)
        MSEjc <- mean((crosscorrelation - (1-j))^2)
        crjc <- cor(1-j,crosscorrelation)
        MSEmic <- mean((crosscorrelation - mi)^2)
        crmic <- cor(mi,crosscorrelation)
        
        
        MSEphasesync <- mean((crosscorrelation - phasesyn)^2)
        crphasesync <- cor(phasesyn,crosscorrelation)
        
        
        
        MSEda01c <- mean((r - (crosscorrelation-da01))^2)
        crda01c <- cor(1-da01,crosscorrelation)
        
        MSEda05c <- mean((crosscorrelation - (1-da05))^2)
        crda05c <- cor(1-da05,crosscorrelation)
        
        MSEda09c <- mean((crosscorrelation - (1-da09))^2)
        crda09c <- cor(1-da09,crosscorrelation)
        
        MSEjr2c <- mean((crosscorrelation - (1-jr2))^2)
        crjr2c <- cor((1-jr2),crosscorrelation)
        
        MSEjr6c <- mean((crosscorrelation - (1-jr6))^2)
        crjr6c <- cor(1-jr6,crosscorrelation)
        
        MSEjr10c <- mean((crosscorrelation - (1-jr10))^2)
        crjr10c <- cor((1-jr10),crosscorrelation)
        ...
        datasave <- rbind(datasave,resultk_low,resultj_low,resultmi_low,
                          ...
                          resultjr6_high,resultjr10_high
        )
        
        datasave.all <- rbind(datasave.all,resultk,resultj,resultmi,resultphasesyn,resultda01,
                              resultda05,resultda09,resultjr2,resultjr6,resultjr10)
        ...
        datasavec <- rbind(datasavec,resultk_lowc,resultj_lowc,resultmi_lowc,
                           ...
                           ,resultjr2_lowc,resultjr6_lowc,resultjr10_lowc,
                           ...
                           resultjr6_avgc,resultjr10_avgc,
                           ...
                           resultjr6_highc,resultjr10_highc
        )
        
        datasave.allc <- rbind(datasave.allc,resultkc,resultjc,resultmic,resultphasesync,resultda01c,
                               resultda05c,resultda09c,resultjr2c,resultjr6c,resultjr10c)
